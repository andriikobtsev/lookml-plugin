...
public class LookMLFiltersBlockBodyImpl extends ASTWrapperPsiElement implements LookMLFiltersBlockBody {

  public LookMLFiltersBlockBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitFiltersBlockBody(this);
  }
