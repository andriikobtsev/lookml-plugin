...
public class LookMLYamlMultilineValueImpl extends ASTWrapperPsiElement implements LookMLYamlMultilineValue {

  public LookMLYamlMultilineValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitYamlMultilineValue(this);
  }
