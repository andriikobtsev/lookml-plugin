...
public class LookMLIncrementKeyPropertyImpl extends ASTWrapperPsiElement implements LookMLIncrementKeyProperty {

  public LookMLIncrementKeyPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitIncrementKeyProperty(this);
  }
