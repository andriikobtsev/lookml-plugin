...
public class LookMLCaseSensitiveStatementImpl extends ASTWrapperPsiElement implements LookMLCaseSensitiveStatement {

  public LookMLCaseSensitiveStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitCaseSensitiveStatement(this);
  }
