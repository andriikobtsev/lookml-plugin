...
public class LookMLBoldPropertyImpl extends ASTWrapperPsiElement implements LookMLBoldProperty {

  public LookMLBoldPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitBoldProperty(this);
  }
