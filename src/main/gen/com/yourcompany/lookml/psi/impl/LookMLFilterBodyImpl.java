...
public class LookMLFilterBodyImpl extends ASTWrapperPsiElement implements LookMLFilterBody {

  public LookMLFilterBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitFilterBody(this);
  }
