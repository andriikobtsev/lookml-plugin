...
public class LookMLLabelPropertyImpl extends ASTWrapperPsiElement implements LookMLLabelProperty {

  public LookMLLabelPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitLabelProperty(this);
  }
