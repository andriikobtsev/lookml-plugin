...
public class LookMLWildcardIdentifierImpl extends ASTWrapperPsiElement implements LookMLWildcardIdentifier {

  public LookMLWildcardIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitWildcardIdentifier(this);
  }
