...
public class LookMLHyphenatedIdentifierImpl extends ASTWrapperPsiElement implements LookMLHyphenatedIdentifier {

  public LookMLHyphenatedIdentifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitHyphenatedIdentifier(this);
  }
