...
public class LookMLFieldPropertyImpl extends ASTWrapperPsiElement implements LookMLFieldProperty {

  public LookMLFieldPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitFieldProperty(this);
  }
  ...
  public LookMLQualifiedIdentifier getQualifiedIdentifier() {
    return findNotNullChildByClass(LookMLQualifiedIdentifier.class);
  }
