...
public class LookMLFromPropertyImpl extends ASTWrapperPsiElement implements LookMLFromProperty {

  public LookMLFromPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitFromProperty(this);
  }
