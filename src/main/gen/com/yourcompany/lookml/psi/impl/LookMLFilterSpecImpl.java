...
public class LookMLFilterSpecImpl extends ASTWrapperPsiElement implements LookMLFilterSpec {

  public LookMLFilterSpecImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitFilterSpec(this);
  }
