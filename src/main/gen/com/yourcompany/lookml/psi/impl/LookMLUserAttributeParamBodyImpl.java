...
public class LookMLUserAttributeParamBodyImpl extends ASTWrapperPsiElement implements LookMLUserAttributeParamBody {

  public LookMLUserAttributeParamBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitUserAttributeParamBody(this);
  }
