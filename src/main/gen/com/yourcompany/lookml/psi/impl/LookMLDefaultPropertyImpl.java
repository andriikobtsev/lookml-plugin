...
public class LookMLDefaultPropertyImpl extends ASTWrapperPsiElement implements LookMLDefaultProperty {

  public LookMLDefaultPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitDefaultProperty(this);
  }
