...
public class LookMLSuggestionsPropertyImpl extends ASTWrapperPsiElement implements LookMLSuggestionsProperty {

  public LookMLSuggestionsPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitSuggestionsProperty(this);
  }
