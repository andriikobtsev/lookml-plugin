...
public class LookMLSortSpecificationImpl extends ASTWrapperPsiElement implements LookMLSortSpecification {

  public LookMLSortSpecificationImpl(@NotNull ASTNode node) {
    super(node);
  }
