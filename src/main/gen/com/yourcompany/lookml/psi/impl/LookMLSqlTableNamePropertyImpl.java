...
public class LookMLSqlTableNamePropertyImpl extends ASTWrapperPsiElement implements LookMLSqlTableNameProperty {

  public LookMLSqlTableNamePropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitSqlTableNameProperty(this);
  }
