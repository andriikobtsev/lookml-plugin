...
public class LookMLElementObjectImpl extends ASTWrapperPsiElement implements LookMLElementObject {

  public LookMLElementObjectImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public LookMLElementBody getElementBody() {
    return findNotNullChildByClass(LookMLElementBody.class);
  }
