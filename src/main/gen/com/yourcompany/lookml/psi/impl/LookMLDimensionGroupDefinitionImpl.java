...
public class LookMLDimensionGroupDefinitionImpl extends ASTWrapperPsiElement implements LookMLDimensionGroupDefinition {

  public LookMLDimensionGroupDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitDimensionGroupDefinition(this);
  }
  ...
  public LookMLPropertyList getPropertyList() {
    return findNotNullChildByClass(LookMLPropertyList.class);
  }
