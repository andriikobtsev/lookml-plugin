...
public class LookMLConnectionStatementImpl extends ASTWrapperPsiElement implements LookMLConnectionStatement {

  public LookMLConnectionStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitConnectionStatement(this);
  }
