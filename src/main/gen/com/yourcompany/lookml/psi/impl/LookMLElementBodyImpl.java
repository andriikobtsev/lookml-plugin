...
public class LookMLElementBodyImpl extends ASTWrapperPsiElement implements LookMLElementBody {

  public LookMLElementBodyImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<LookMLConditionalFormattingProperty> getConditionalFormattingPropertyList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, LookMLConditionalFormattingProperty.class);
  }
