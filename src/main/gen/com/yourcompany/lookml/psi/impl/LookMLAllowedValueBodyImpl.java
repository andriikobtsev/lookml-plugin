...
public class LookMLAllowedValueBodyImpl extends ASTWrapperPsiElement implements LookMLAllowedValueBody {

  public LookMLAllowedValueBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitAllowedValueBody(this);
  }
