...
public class LookMLFilterDefinitionImpl extends ASTWrapperPsiElement implements LookMLFilterDefinition {

  public LookMLFilterDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitFilterDefinition(this);
  }
