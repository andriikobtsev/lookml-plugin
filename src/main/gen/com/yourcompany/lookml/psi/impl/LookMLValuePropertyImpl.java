...
public class LookMLValuePropertyImpl extends ASTWrapperPsiElement implements LookMLValueProperty {

  public LookMLValuePropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitValueProperty(this);
  }
