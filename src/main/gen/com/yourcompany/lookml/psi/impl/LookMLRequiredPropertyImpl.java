...
public class LookMLRequiredPropertyImpl extends ASTWrapperPsiElement implements LookMLRequiredProperty {

  public LookMLRequiredPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitRequiredProperty(this);
  }
