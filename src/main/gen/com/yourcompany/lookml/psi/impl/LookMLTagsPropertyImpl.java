...
public class LookMLTagsPropertyImpl extends ASTWrapperPsiElement implements LookMLTagsProperty {

  public LookMLTagsPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitTagsProperty(this);
  }
