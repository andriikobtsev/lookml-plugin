...
public class LookMLWhenClauseImpl extends ASTWrapperPsiElement implements LookMLWhenClause {

  public LookMLWhenClauseImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public LookMLWhenBody getWhenBody() {
    return findNotNullChildByClass(LookMLWhenBody.class);
  }
