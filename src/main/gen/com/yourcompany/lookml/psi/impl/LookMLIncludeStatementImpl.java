...
public class LookMLIncludeStatementImpl extends ASTWrapperPsiElement implements LookMLIncludeStatement {

  public LookMLIncludeStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
