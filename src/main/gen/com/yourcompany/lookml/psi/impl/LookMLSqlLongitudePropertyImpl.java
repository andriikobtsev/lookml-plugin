...
public class LookMLSqlLongitudePropertyImpl extends ASTWrapperPsiElement implements LookMLSqlLongitudeProperty {

  public LookMLSqlLongitudePropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitSqlLongitudeProperty(this);
  }
