...
public class LookMLDatagroupBodyImpl extends ASTWrapperPsiElement implements LookMLDatagroupBody {

  public LookMLDatagroupBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitDatagroupBody(this);
  }
  ...
  @Override
  @NotNull
  public List<LookMLSqlTriggerProperty> getSqlTriggerPropertyList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, LookMLSqlTriggerProperty.class);
  }
