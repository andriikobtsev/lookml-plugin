...
public class LookMLViewDefinitionImpl extends ASTWrapperPsiElement implements LookMLViewDefinition {

  public LookMLViewDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public LookMLViewBody getViewBody() {
    return findNotNullChildByClass(LookMLViewBody.class);
  }
