...
public class LookMLTestDefinitionImpl extends ASTWrapperPsiElement implements LookMLTestDefinition {

  public LookMLTestDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public LookMLTestBody getTestBody() {
    return findNotNullChildByClass(LookMLTestBody.class);
  }
