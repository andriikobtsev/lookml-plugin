...
public class LookMLSqlFieldReferenceImpl extends ASTWrapperPsiElement implements LookMLSqlFieldReference {

  public LookMLSqlFieldReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitSqlFieldReference(this);
  }
