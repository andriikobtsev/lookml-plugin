...
public class LookMLDatagroupTriggerPropertyImpl extends ASTWrapperPsiElement implements LookMLDatagroupTriggerProperty {

  public LookMLDatagroupTriggerPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitDatagroupTriggerProperty(this);
  }
