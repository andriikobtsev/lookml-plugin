...
public class LookMLTypePropertyImpl extends ASTWrapperPsiElement implements LookMLTypeProperty {

  public LookMLTypePropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitTypeProperty(this);
  }
