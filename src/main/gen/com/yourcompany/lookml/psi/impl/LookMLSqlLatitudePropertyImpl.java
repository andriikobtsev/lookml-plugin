...
public class LookMLSqlLatitudePropertyImpl extends ASTWrapperPsiElement implements LookMLSqlLatitudeProperty {

  public LookMLSqlLatitudePropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitSqlLatitudeProperty(this);
  }
