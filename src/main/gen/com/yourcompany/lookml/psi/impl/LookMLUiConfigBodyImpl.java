...
public class LookMLUiConfigBodyImpl extends ASTWrapperPsiElement implements LookMLUiConfigBody {

  public LookMLUiConfigBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitUiConfigBody(this);
  }
  ...
  @Override
  @NotNull
  public List<LookMLDisplayProperty> getDisplayPropertyList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, LookMLDisplayProperty.class);
  }

  @Override
  @NotNull
  public List<LookMLOptionsProperty> getOptionsPropertyList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, LookMLOptionsProperty.class);
  }
