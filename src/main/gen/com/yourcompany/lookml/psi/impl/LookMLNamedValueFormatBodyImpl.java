...
public class LookMLNamedValueFormatBodyImpl extends ASTWrapperPsiElement implements LookMLNamedValueFormatBody {

  public LookMLNamedValueFormatBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitNamedValueFormatBody(this);
  }
