...
public class LookMLParamBodyImpl extends ASTWrapperPsiElement implements LookMLParamBody {

  public LookMLParamBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitParamBody(this);
  }
