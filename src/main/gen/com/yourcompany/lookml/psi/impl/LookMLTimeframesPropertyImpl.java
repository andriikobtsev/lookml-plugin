...
public class LookMLTimeframesPropertyImpl extends ASTWrapperPsiElement implements LookMLTimeframesProperty {

  public LookMLTimeframesPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitTimeframesProperty(this);
  }
