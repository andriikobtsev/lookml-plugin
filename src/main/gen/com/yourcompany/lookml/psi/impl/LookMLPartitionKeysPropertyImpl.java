...
public class LookMLPartitionKeysPropertyImpl extends ASTWrapperPsiElement implements LookMLPartitionKeysProperty {

  public LookMLPartitionKeysPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitPartitionKeysProperty(this);
  }
