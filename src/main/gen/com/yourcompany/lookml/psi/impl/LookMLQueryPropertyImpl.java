...
public class LookMLQueryPropertyImpl extends ASTWrapperPsiElement implements LookMLQueryProperty {

  public LookMLQueryPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public LookMLQueryBody getQueryBody() {
    return findNotNullChildByClass(LookMLQueryBody.class);
  }
