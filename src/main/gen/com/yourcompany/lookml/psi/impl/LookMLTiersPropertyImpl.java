...
public class LookMLTiersPropertyImpl extends ASTWrapperPsiElement implements LookMLTiersProperty {

  public LookMLTiersPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitTiersProperty(this);
  }
