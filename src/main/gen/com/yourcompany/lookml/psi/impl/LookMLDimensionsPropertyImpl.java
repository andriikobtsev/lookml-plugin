...
public class LookMLDimensionsPropertyImpl extends ASTWrapperPsiElement implements LookMLDimensionsProperty {

  public LookMLDimensionsPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitDimensionsProperty(this);
  }
