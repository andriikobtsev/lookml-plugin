...
public class LookMLRequiredJoinsPropertyImpl extends ASTWrapperPsiElement implements LookMLRequiredJoinsProperty {

  public LookMLRequiredJoinsPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitRequiredJoinsProperty(this);
  }
