...
public class LookMLIconUrlPropertyImpl extends ASTWrapperPsiElement implements LookMLIconUrlProperty {

  public LookMLIconUrlPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitIconUrlProperty(this);
  }
