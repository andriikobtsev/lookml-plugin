...
public class LookMLMeasuresPropertyImpl extends ASTWrapperPsiElement implements LookMLMeasuresProperty {

  public LookMLMeasuresPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitMeasuresProperty(this);
  }
