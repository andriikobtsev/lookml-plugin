...
public class LookMLLabelStatementImpl extends ASTWrapperPsiElement implements LookMLLabelStatement {

  public LookMLLabelStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
