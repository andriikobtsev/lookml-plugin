...
public class LookMLYamlFlowValueImpl extends ASTWrapperPsiElement implements LookMLYamlFlowValue {

  public LookMLYamlFlowValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitYamlFlowValue(this);
  }
  ...
  @Override
  @Nullable
  public LookMLYamlFlowArray getYamlFlowArray() {
    return findChildByClass(LookMLYamlFlowArray.class);
  }
