...
public class LookMLFormUrlPropertyImpl extends ASTWrapperPsiElement implements LookMLFormUrlProperty {

  public LookMLFormUrlPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitFormUrlProperty(this);
  }
