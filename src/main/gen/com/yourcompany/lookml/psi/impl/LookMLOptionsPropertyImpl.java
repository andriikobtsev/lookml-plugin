...
public class LookMLOptionsPropertyImpl extends ASTWrapperPsiElement implements LookMLOptionsProperty {

  public LookMLOptionsPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitOptionsProperty(this);
  }
