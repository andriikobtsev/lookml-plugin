...
public class LookMLDisplayPropertyImpl extends ASTWrapperPsiElement implements LookMLDisplayProperty {

  public LookMLDisplayPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitDisplayProperty(this);
  }
