...
public class LookMLDimensionDefinitionImpl extends ASTWrapperPsiElement implements LookMLDimensionDefinition {

  public LookMLDimensionDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitDimensionDefinition(this);
  }
