...
public class LookMLIdentifierPartImpl extends ASTWrapperPsiElement implements LookMLIdentifierPart {

  public LookMLIdentifierPartImpl(@NotNull ASTNode node) {
    super(node);
  }
