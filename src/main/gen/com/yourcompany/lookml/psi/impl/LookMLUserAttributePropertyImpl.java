...
public class LookMLUserAttributePropertyImpl extends ASTWrapperPsiElement implements LookMLUserAttributeProperty {

  public LookMLUserAttributePropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitUserAttributeProperty(this);
  }
