...
public class LookMLAccessGrantBodyImpl extends ASTWrapperPsiElement implements LookMLAccessGrantBody {

  public LookMLAccessGrantBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitAccessGrantBody(this);
  }
