...
public class LookMLPersistWithStatementImpl extends ASTWrapperPsiElement implements LookMLPersistWithStatement {

  public LookMLPersistWithStatementImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitPersistWithStatement(this);
  }
