...
public class LookMLTemplateReferenceImpl extends ASTWrapperPsiElement implements LookMLTemplateReference {

  public LookMLTemplateReferenceImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitTemplateReference(this);
  }
