...
public class LookMLTimezonePropertyImpl extends ASTWrapperPsiElement implements LookMLTimezoneProperty {

  public LookMLTimezonePropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitTimezoneProperty(this);
  }
