...
public class LookMLBackgroundColorPropertyImpl extends ASTWrapperPsiElement implements LookMLBackgroundColorProperty {

  public LookMLBackgroundColorPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitBackgroundColorProperty(this);
  }
