...
public class LookMLFieldsPropertyImpl extends ASTWrapperPsiElement implements LookMLFieldsProperty {

  public LookMLFieldsPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitFieldsProperty(this);
  }
