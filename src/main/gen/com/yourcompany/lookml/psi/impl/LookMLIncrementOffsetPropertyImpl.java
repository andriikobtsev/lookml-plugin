...
public class LookMLIncrementOffsetPropertyImpl extends ASTWrapperPsiElement implements LookMLIncrementOffsetProperty {

  public LookMLIncrementOffsetPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitIncrementOffsetProperty(this);
  }
