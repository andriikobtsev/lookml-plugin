...
public class LookMLColumnBodyImpl extends ASTWrapperPsiElement implements LookMLColumnBody {

  public LookMLColumnBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitColumnBody(this);
  }
