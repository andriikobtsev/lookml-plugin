...
public class LookMLViewNamePropertyImpl extends ASTWrapperPsiElement implements LookMLViewNameProperty {

  public LookMLViewNamePropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitViewNameProperty(this);
  }
