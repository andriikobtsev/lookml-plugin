...
public class LookMLParameterDefinitionImpl extends ASTWrapperPsiElement implements LookMLParameterDefinition {

  public LookMLParameterDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }
