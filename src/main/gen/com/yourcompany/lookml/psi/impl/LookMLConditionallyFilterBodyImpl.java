...
public class LookMLConditionallyFilterBodyImpl extends ASTWrapperPsiElement implements LookMLConditionallyFilterBody {

  public LookMLConditionallyFilterBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitConditionallyFilterBody(this);
  }
  ...
  @Override
  @NotNull
  public List<LookMLUnlessProperty> getUnlessPropertyList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, LookMLUnlessProperty.class);
  }
