...
public class LookMLSetBodyImpl extends ASTWrapperPsiElement implements LookMLSetBody {

  public LookMLSetBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitSetBody(this);
  }
