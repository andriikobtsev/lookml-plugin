...
public class LookMLDefaultValuePropertyImpl extends ASTWrapperPsiElement implements LookMLDefaultValueProperty {

  public LookMLDefaultValuePropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitDefaultValueProperty(this);
  }
