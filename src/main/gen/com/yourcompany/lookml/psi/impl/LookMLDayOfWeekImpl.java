...
public class LookMLDayOfWeekImpl extends ASTWrapperPsiElement implements LookMLDayOfWeek {

  public LookMLDayOfWeekImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitDayOfWeek(this);
  }
