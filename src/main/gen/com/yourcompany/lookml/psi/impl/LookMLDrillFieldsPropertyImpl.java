...
public class LookMLDrillFieldsPropertyImpl extends ASTWrapperPsiElement implements LookMLDrillFieldsProperty {

  public LookMLDrillFieldsPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitDrillFieldsProperty(this);
  }
