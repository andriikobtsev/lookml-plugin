...
public class LookMLYamlPropertyNamePartImpl extends ASTWrapperPsiElement implements LookMLYamlPropertyNamePart {

  public LookMLYamlPropertyNamePartImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitYamlPropertyNamePart(this);
  }
