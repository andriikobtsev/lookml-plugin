...
public class LookMLIndexesPropertyImpl extends ASTWrapperPsiElement implements LookMLIndexesProperty {

  public LookMLIndexesPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }
