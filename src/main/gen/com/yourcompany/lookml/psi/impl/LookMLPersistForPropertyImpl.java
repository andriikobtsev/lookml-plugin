...
public class LookMLPersistForPropertyImpl extends ASTWrapperPsiElement implements LookMLPersistForProperty {

  public LookMLPersistForPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitPersistForProperty(this);
  }
