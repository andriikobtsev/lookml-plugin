...
public class LookMLUrlPropertyImpl extends ASTWrapperPsiElement implements LookMLUrlProperty {

  public LookMLUrlPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitUrlProperty(this);
  }
