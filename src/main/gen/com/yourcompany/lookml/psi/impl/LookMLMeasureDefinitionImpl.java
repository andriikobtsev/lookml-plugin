...
public class LookMLMeasureDefinitionImpl extends ASTWrapperPsiElement implements LookMLMeasureDefinition {

  public LookMLMeasureDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitMeasureDefinition(this);
  }
