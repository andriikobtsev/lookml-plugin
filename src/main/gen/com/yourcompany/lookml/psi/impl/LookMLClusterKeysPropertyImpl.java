...
public class LookMLClusterKeysPropertyImpl extends ASTWrapperPsiElement implements LookMLClusterKeysProperty {

  public LookMLClusterKeysPropertyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitClusterKeysProperty(this);
  }
