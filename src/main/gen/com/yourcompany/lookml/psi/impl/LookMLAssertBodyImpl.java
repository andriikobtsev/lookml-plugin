...
public class LookMLAssertBodyImpl extends ASTWrapperPsiElement implements LookMLAssertBody {

  public LookMLAssertBodyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull LookMLVisitor visitor) {
    visitor.visitAssertBody(this);
  }
  ...
  @Override
  @NotNull
  public List<LookMLExpressionProperty> getExpressionPropertyList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, LookMLExpressionProperty.class);
  }
